        ...
        >
            ...
            >
                ...
                >
                    <Heading 
                        ...
                        paddingTop={6}
                    >
                        <Text as={'span'} color={bookshelfColors.secondary.main}>
                            20% {' '}
                        </Text>
                        discount on the promo code
                        <Text fontSize={'3xl'} color={bookshelfColors.secondary.main}>
                            “WETRIEDSE104”
                        </Text>
                    </Heading>
                    <Flex>
            ...
            >
                <Heading fontSize={'2xl'} color={bookshelfColors.white}>
                    <Text as={'span'} color={bookshelfColors.secondary.light}>30% {' '}</Text>
                    discount on all books from {' '}
                    <Text as={'span'} color={bookshelfColors.secondary.light}>June 19 to June 25</Text>
                </Heading>
                <Flex>
