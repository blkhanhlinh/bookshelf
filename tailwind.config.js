  ...
  theme: {
    extend: {
      ...
      dropShadow: {
        ...
        'yellow-lg': '-4px 16px 32px -4px rgba(255, 156, 40, 0.08), 4px -4px 16px 2px rgba(255, 156, 40, 0.05',
        'yellow-xl': '0px 25px 50px -12px rgba(255, 156, 40, 0.25)',
        'yellow-2xl': '2px 10px 15px -3px rgba(255, 156, 40, 0.25), -2px 4px 6px -2px rgba(255, 156, 40, 0.1)',
